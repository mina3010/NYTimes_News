package com.minamagid.thechallenge.domain.use_case.get_most_shared
...
class GetMostSharedArticlesOnFacebookUseCase @Inject constructor(private val repository: Repository) {
     operator fun invoke(): Flow<Resource<GeneralResponse>> = flow {
        try {
            val details = repository.getMostEmailedArticles()
